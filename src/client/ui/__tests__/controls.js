...
describe('<StorybookControls />', function () {
  describe('render', function () {
    it('should render stories - empty', function () {
      ...
      const list = wrap.find('div.stories-list').first();
  ...
  describe('functions', function () {
    it('should call the onKind prop when a kind is clicked', function () {
      ...
      const kind = wrap.find('div.stories-list-kind').reduce(function (res, n) {
        return n.text() === 'a' ? n : res;
      });
      kind.simulate('click');
    ...
    it('should call the onStory prop when a story is clicked', function () {
      ...
      const story = wrap.find('div.stories-list-story').reduce(function (res, n) {
        return n.text() === 'a1' ? n : res;
      });
